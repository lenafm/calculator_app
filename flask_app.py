...
from test_circle import test_calculate
...
def circle():
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template('circle.html', printed_result="Invalid radius input")

        try:
            result = test_calculate(radius=radius, operation=operation)
            return render_template('circle.html', printed_result=str(result))

        except Exception as e:
            return render_template('circle.html', printed_result="An error occurred")
