...
def test_circle_calculation_area():
    ...
    #circle = Circle(-1)
    #assert circle.circle_calculation(-1, "area") == "Invalid input for radius" == NEED TO MAKE IT ROBUST TO NEG NUMBERS
...
def test_circle_calculation_perimeter():
    ...
    #circle = Circle(-1)
    #assert circle.circle_calculation(-1, "perimeter") == "Invalid input for radius" == NEED TO MAKE IT ROBUST TO NEG NUMBERS
    circle = Circle(0.0001)
